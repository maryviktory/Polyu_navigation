...
class SecondaryMonitor(Thread):
    ...
    def __init__(self, host, use_simulation=False):
        ...
        self._dictLock = Lock()
        self.host = host
        secondary_port = 30002    # 30002 Secondary client interface on Universal Robots
        self._s_secondary = socket.create_connection((self.host, secondary_port), timeout=2) #timeout=0.5
        self._prog_queue = []
    ...
    def wait(self, timeout=10): #original value is 0.5
        """
