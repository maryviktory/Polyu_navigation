...
config.MODEL.PRETRAINED = "/media/maryviktory/My Passport/spine navigation Polyu 2021/DATASET_polyu/models_CNN/model_best_resnet_fixed_False_pretrained_True_phantom_classes.pt"
    #'/media/maryviktory/My Passport/spine navigation Polyu 2021/DATASET_polyu/model_best_resnet_fixed_False_pretrained_True_data_19subj_2_2_classes_exp6105.pt'
...
config.DATASET.PATH ="/media/maryviktory/My Passport/spine navigation Polyu 2021/DATASET_polyu/FCN_PWH_train_dataset_heatmaps/phantom"
...
config.DATASET.OUTPUT_PATH ="/media/maryviktory/My Passport/spine navigation Polyu 2021/DATASET_polyu/FCN_PWH_train_dataset_heatmaps/phantom"
#"/media/maryviktory/My Passport/IROS 2020 TUM/Spine navigation vertebrae tracking/FCN_spine_point_regression/Small_dataset_heatmaps"
...
config.TEST.VIDEO = True
config.TEST.labels_exist = True
config.TRAIN.SWEEP_TRJ_PLOT = True
...
config.TEST.MODEL_FILE = '/media/maryviktory/My Passport/spine navigation Polyu 2021/DATASET_polyu/models_FCN/best_model_exp36817.pt'
#"/media/maryviktory/My Passport/IROS 2020 TUM/DATASETs/models/best_model.pt"
config.TEST.PROBE_SIZE = 48 #mm
config.TEST.ORIGINAL_IMAGE_SIZE = 480
