...
import time
import argparse
# from sp_utils.run_test_without_labels import run_test_without_labels_multiclass
# from sp_utils import smooth
...
def main():
    ...
    try:
        ...
        config.TEST.sweep_data_dir = "data_19subj_15train_no_sacrum_lab/"
        config.TEST.save_dir = os.path.join("data_19subj_15train_no_sacrum_lab/runs", args.data_dir)
        config.TEST.MODEL_FILE = os.path.join(config.TEST.save_dir,args.model_dir)
...
def Parser():
    ...
    parser.add_argument('--data_dir', type=str, default="data_19subj_15train_no_sacrum_lab/runs", metavar='N',
                        help='')
    parser.add_argument('--model_dir', type=str, default="data_19subj_15train_no_sacrum_lab/runs", metavar='N',
                        help='')
