...
import sp_utils.f_processing as process
...
def data_extraction():
    traj_path = "/media/maryviktory/My Passport/IROS 2020 TUM/Spine navigation vertebrae tracking/FCN_spine_point_regression/Dataset_Heatmaps_all_subjects/Maria_T/Maria_T.csv"
    ...
    p_i, p_e, _ = process.find_valid_indexes(y)
